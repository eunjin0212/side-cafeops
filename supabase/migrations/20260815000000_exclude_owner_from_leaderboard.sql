-- ============================================================
-- Migration: Exclude owner-role profiles from get_leaderboard results
-- Owners don't participate in the performance ranking system.
-- ============================================================
...
-- 20260814000000_restrict_leaderboard_by_location.sql (no role filter).
